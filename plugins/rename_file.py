    ...
    if update_channel:
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="Join My Updates group", url=f"https://t.me/MALAYALAMDUBBEDMOVIEGROUP")]
              ])
            )
            return
    ...
    if (" " in update.text) and (update.reply_to_message is not None):
        ...
        if the_real_download_location is not None:
            ...
            await bot.send_document(
                ...
                parse_mode = "html",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="join our movie group", url=f"https://t.me/Malayalamdubbedmoviegroup")]
              ]), 
